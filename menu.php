        ...
        <div class="">
            ...
            <div class="col-md-12 row">
                <div v-for="producto in list['empanadas']" class="col-md-4 mb-4 row">
                    <div class="col">
                        <img v-bind:src="producto['src']" class="w200 h200 img-thumbnail hr1" alt="">
                    </div>
                    <div class="col">
                        <label for="" class="">{{producto['nombre']}}</label>
                        <p>
                            <label for="" class="bb5">${{producto['precio']}}</label>
                        </p>
                        <p>
                            <label class="text-danger" v-if="producto['precio'] > 100">Oferta</label>
                        </p>
                        <p class="text-streng">
                            <a href="" class="btn btn-success hr1 t5">comprar</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-12 row">
                <div v-for="producto in list['pizzas']" class="col-md-4 mb-4 row">
                    <div class="col">
                        <img v-bind:src="producto['src']" class="w200 h200 img-thumbnail  hr2hr2" alt="">
                    </div>
                    <div class="col">
                        <label for="" class="">{{producto['nombre']}}</label>
                        <p>
                            <label for="" class="">${{producto['precio']}}</label>
                        </p>
                        <p class="text-streng">
...
<section class="m-5">
    <div class="col-md-12 row text-laight">
        <div class="col-md-6 row justify-content-around align-content-around" v-for="producto in list['empanadas']">
            <div class="col">
                <img v-bind:src="producto['src']" class="w200 h200 rounded-circle hr2" alt="">
            </div>
            <div class="col text-light">
                <p class="">
                    <span class="">{{producto['nombre']}}</span>
                    <span cl>${{producto['precio']}}</span>
                </p>
